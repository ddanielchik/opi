...
<head>
    ...
    <title><fmt:message key="error.403.title" bundle="${msg}"/></title>
</head>
<body>
<header>
    <h1><fmt:message key="error.403.title" bundle="${msg}"/></h1>
</header>

<main>
    <div class="error-content">
        <p><fmt:message key="error.403.message" bundle="${msg}"/></p>
